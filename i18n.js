...
(function () {
  ...
  var DICT = {
    ru: {
      ...
      "Open 24h": "Работаем 24ч", "Pattaya": "Паттайя",
      "Prices in Thai Baht (฿)": "Цены в тайских батах (฿)",
      "Chicken Boxes": "Куриные боксы", "Hot Dogs": "Хот-доги", "Sauces": "Соусы", "Drinks": "Напитки",
      // ---- Menu page: combos ----
      "Combos": "Комбо",
      "Best value — a meal in one tap. Prices in Thai Baht (฿).": "Лучшая цена — целый обед в один клик. Цены в тайских батах (฿).",
      "Dog Combo": "Комбо с хот-догом", "Hot dog, fries & a soda": "Хот-дог, картофель фри и газировка",
      "Chicken Combo": "Комбо с курицей", "Pop chicken, a drink & sauce": "Курица Поп, напиток и соус",
      "Fendi's Big Box": "Большой бокс Fendi", "Family box, 2 sodas & 2 sauces": "Семейный бокс, 2 газировки и 2 соуса",
      "Breakfast + Juice": "Завтрак + сок", "Breakfast sandwich & a fresh juice": "Сэндвич на завтрак и свежий сок",
      "Late-Night Bundle": "Ночной набор", "Hot dog, Lite chicken & a soda": "Хот-дог, курица Лайт и газировка",
      "★ Popular": "★ Хит",
      // ---- Menu page: chicken boxes / hot dogs extras ----
      "Golden, double-crunch fried chicken, still hot.": "Золотистая курица двойной обжарки, ещё горячая.",
      "Make it yours": "Собери по-своему", "Build Your Own Hot Dog": "Собери свой хот-дог",
      "Start with a sausage in a soft bun, then load it up.": "Начни с сосиски в мягкой булочке, а дальше добавь по вкусу.",
      "Cheese +20 ฿": "Сыр +20 ฿", "Bacon +25 ฿": "Бекон +25 ฿", "Chili +30 ฿": "Чили +30 ฿",
      "Onions +15 ฿": "Лук +15 ฿", "Jalapeños +15 ฿": "Халапеньо +15 ฿", "Crispy onions +15 ฿": "Хрустящий лук +15 ฿",
      "Double sausage +45 ฿": "Двойная сосиска +45 ฿", "Extra sauce +10 ฿": "Доп. соус +10 ฿",
      "Soda": "Газировка", "Juice": "Сок", "Tartar Sauce": "Соус тартар",
      "Order at the counter": "Заказать на кассе",
    ...
    th: {
      ...
      "Open 24h": "เปิด 24 ชม.", "Pattaya": "พัทยา",
      "Prices in Thai Baht (฿)": "ราคาเป็นเงินบาท (฿)",
      "Chicken Boxes": "กล่องไก่", "Hot Dogs": "ฮอทดอก", "Sauces": "ซอส", "Drinks": "เครื่องดื่ม",
      // ---- Menu page: combos ----
      "Combos": "ชุดคอมโบ",
      "Best value — a meal in one tap. Prices in Thai Baht (฿).": "คุ้มที่สุด — อิ่มครบในชุดเดียว ราคาเป็นเงินบาท (฿)",
      "Dog Combo": "คอมโบฮอทดอก", "Hot dog, fries & a soda": "ฮอทดอก เฟรนช์ฟรายส์ และน้ำอัดลม",
      "Chicken Combo": "คอมโบไก่", "Pop chicken, a drink & sauce": "ไก่ป๊อป เครื่องดื่ม และซอส",
      "Fendi's Big Box": "กล่องใหญ่ของเฟนดิ", "Family box, 2 sodas & 2 sauces": "กล่องครอบครัว น้ำอัดลม 2 และซอส 2",
      "Breakfast + Juice": "อาหารเช้า + น้ำผลไม้", "Breakfast sandwich & a fresh juice": "แซนด์วิชอาหารเช้า และน้ำผลไม้สด",
      "Late-Night Bundle": "ชุดดึก", "Hot dog, Lite chicken & a soda": "ฮอทดอก ไก่ไลท์ และน้ำอัดลม",
      "★ Popular": "★ ยอดนิยม",
      // ---- Menu page: chicken boxes / hot dogs extras ----
      "Golden, double-crunch fried chicken, still hot.": "ไก่ทอดสีทองกรอบสองชั้น ร้อน ๆ",
      "Make it yours": "จัดในแบบคุณ", "Build Your Own Hot Dog": "สร้างฮอทดอกของคุณเอง",
      "Start with a sausage in a soft bun, then load it up.": "เริ่มจากไส้กรอกในขนมปังนุ่ม แล้วเพิ่มท็อปปิ้งตามใจ",
      "Cheese +20 ฿": "ชีส +20 ฿", "Bacon +25 ฿": "เบคอน +25 ฿", "Chili +30 ฿": "พริก +30 ฿",
      "Onions +15 ฿": "หอมใหญ่ +15 ฿", "Jalapeños +15 ฿": "ฮาลาปิโน +15 ฿", "Crispy onions +15 ฿": "หอมเจียว +15 ฿",
      "Double sausage +45 ฿": "ไส้กรอกสองชั้น +45 ฿", "Extra sauce +10 ฿": "ซอสเพิ่ม +10 ฿",
      "Soda": "น้ำอัดลม", "Juice": "น้ำผลไม้", "Tartar Sauce": "ซอสทาร์ทาร์",
      "Order at the counter": "สั่งที่เคาน์เตอร์",
